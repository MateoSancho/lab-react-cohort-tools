...
function StudentCard({
  ...
  className,
    ...
    <Link to={`/students/${_id}`} className="block">
      <div className={`StudentCard flex justify-between items-center p-3 mb-2 bg-white shadow-sm rounded border border-gray-200 hover:bg-gray-50 cursor-pointer transition-colors ${className}`}>
